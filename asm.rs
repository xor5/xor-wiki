...
fn shellcode() {
    unsafe {
        asm!(
            "
            /*
                1. Example of calling 'test' with x arguments
                ...
                2. Example of defining a variable at (runtime?)
            ...
            */
            ...
            mov dword ptr [rbp-8], 0x0A # 10
            mov dword ptr [rbp-16], 0x0B # 11
            mov dword ptr [rbp-24], 0x0C # 12
            
            # Could also just be written as the raw value itself
